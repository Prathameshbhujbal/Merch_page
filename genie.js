const productDetails = [
  {
    name: "Victory Premium Polo",
    price: 544,
    imageUrl:
      "https://cdn.shopify.com/s/files/1/0589/9773/5624/products/TShirtDesign-3copy_1024x1024@2x.jpg?v=1640586663",
    qty: 10,
    heading: "Regular Fit Half Sleeve Polo, Contrast Placket and Piping 240 GSM, 100% Premium Cotton,",
    des:
      "IIT Madras Victory Premium Polo",
  },
  {
    name: "IIT Madras Camou T-Shirt",
    price: 409,
    imageUrl: "https://cdn.shopify.com/s/files/1/0589/9773/5624/products/Samplecopy_1024x1024@2x.jpg?v=1640586848https://purepng.com/public/uploads/large/apple-watch-pcq.png",
    qty: 15,
    heading: "Regular Fit Half Sleeve Polo, Contrast Placket and Piping 240 GSM, 100% Premium Cotton,You ve never seen a watch like this",
    des:
    "IIT Madras Victory Premium Polo"},
  {
    name: "IIT Madras Camou T-Shirt",
    ...
    "IIT Madras Victory Premium Polo"},
  {
    name: "IIT Madras Victory Premium Polo",
    price: 600,
    imageUrl:
    ...
    "IIT Madras Victory Premium Polo"},
  {
    ...
    price:900,
    imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8Nyqd-d7QuLZSQJCx5huZsO-7yaLvLZsAnB34epZAZAv18kGVDbRV1XfHmDzrsqD5CSw&usqp=CAU",
    qty: 25,
    heading: "Regular Fit Half Sleeve Polo, Contrast Placket and Piping 240 GSM, 100% Premium Cotton,",
    des:
    "IIT Madras Victory Premium Polo"},
...
function sideNav(handler) {
  ...
  let cover = document.getElementsByClassName("")[0];
...
function QtyBtn(qty = 1) {
  ...
  return `
<div>
  <button class='btn-qty' onclick="qtyChange(this,'sub')">-</i></button>
  <p class='qty'>${qty}</p>
  <button class='btn-qty' onclick="qtyChange(this,'add')">+</i></button>
</div>`;
}
//}
...
<div class='side-nav'>
<h2>Cart</h2>
  <button onclick='sideNav(0)' class="closeBTN"><i class='fas fa-times'></i></button>
